...
public class Searcher {
	...
	public Searcher(String indexPath, boolean RAM){
		BooleanQuery.setMaxClauseCount(maxClauseCount);		
		setIndexReader(getIndex(indexPath, RAM));
		setIndexSearcher();		
	}
	...
	private Directory getIndex(String indexPath, boolean RAM) {		
		...
		try {
			...
			if(RAM) {
				Directory ramDirectory = new RAMDirectory(index);
				System.out.println("index uploaded in RAM");
				index.close();
				return ramDirectory;
			}			
		} catch (IOException e) {
